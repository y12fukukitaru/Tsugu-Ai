...
// ② 顧客向け：物語の表と、デモの画面（1年後）が同じ数字
{
  ...
  ok('売り手：準備の費用 3万×36＋5万＝113万 < 残業代432万', 3 * 36 === 108 && 108 + 5 < 432 && PITC.indexOf('月3万×36か月＝108万＋初期導入費5万') >= 0);
  ok('売り手：売り手プランの額は料金の頁と同じ', PITC.indexOf('売り手プランは<b>月30,000円</b>') >= 0 && PITC.indexOf('売り手プラン（譲渡準備）30,000円') >= 0);
